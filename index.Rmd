...
Dear reader,
Welcome to my musicology GitHub page! In the next tab, you'll find visualisations of the class corpus, along with detailed analyses of two tracks—one of which was created using AI.

For this portfolio, I composed one track with the help of generative AI. Can you guess which one?
The second track was sourced from SoundCloud’s open library. While I assume it was human-made, I can’t say for sure—it might also be AI-generated. Hopefully, the analysis that follows will help shed some light on whether it was made by a human, or perhaps a collaboration between human and machine.

As for my AI-generated track, here’s the prompt I used (I’d like to think it’s pretty creative):
...
cat('<audio controls>
<source src=""C:\Users\aneru\musika2\Aleksandra_B-1.mp3.mp3"" type="audio/mpeg">
...
cat('<audio controls>
<source src=""C:\Users\aneru\musika2\Aleksandra_B-2.mp3.mp3"" type="audio/mpeg">
Your browser does not support the audio element.
</audio>')
...
There is a grey trend line in the graph, showing that as Valence increases (songs sound happier), Arousal also tends to increase (songs have more energy). The gray area around the line shows some uncertainty, meaning not every song follows this trend exactly.
...
```
-----------------------------------------------------------------------
This confusion matrix shows how well the model did in telling apart AI-generated tracks from Non-AI ones in the class corpus.

- It correctly identified **37 AI tracks** as AI.  
- It got **21 AI tracks wrong**, calling them Non-AI.  
- It correctly identified **20 Non-AI tracks**.  
- But it also **mistook 12 Non-AI tracks** for AI.

So overall, the model is pretty good at spotting AI tracks but still makes some mistakes. It sometimes thinks human-made music is AI and sometimes misses AI tracks that sound more natural. This shows that some AI tracks can be very close to real ones, making them harder to tell apart.
...
```
-----------------------------------------------------------------------
This is the final graph in my class corpus section. It shows all the tracks plotted by **valence** and **arousal**, with **tempo** shown by the size of the dots. AI-generated tracks are in purple, and Non-AI tracks are in yellow.

We can see that AI and Non-AI tracks are quite mixed, which matches what we saw earlier in the confusion matrix — the model had trouble separating them clearly. Still, AI tracks seem to lean a bit more toward the top right (higher arousal and valence), while Non-AI tracks are more spread out. Tempo doesn't seem to be a clear difference, since both AI and Non-AI tracks have a mix of slow and fast songs.

Overall, this graph helps to confirm that even though there are some patterns, AI and Non-AI tracks often look similar in terms of these features. 
