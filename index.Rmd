...
cat('
<audio controls>
  <source src="aleksandra-b-1.mp3" type="audio/mpeg">
...
cat('
<audio controls>
  <source src="aleksandra-b-2.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
')
...
Working on this portfolio helped me understand the differences between a human-made and an AI-generated track by using various computational musicology tools. Through visual analyses like chromagrams, tempograms, cepstrograms, novelty functions, and self-similarity matrices, I was able to notice contrasts. For instance, my AI-generated track was much more repetitive and predictable, while the human-made one had smoother transitions, more variation, and a more natural sense of musical development.

However, I also realized that a lot depends on the person’s musical background. AS for me, I don’t have any music theory or programming background, so creating a musically interesting AI track was quite challenging. I think with more knowledge of harmony or structure, I could have guided the AI to make something better. So in a way, this project showed me how generative tools still rely heavily on human input and basic knowledge.

In the 'programming section', I explored clustering and classification using models like KNN and random forests. It was interesting to understand how features like instrumentalness, arousal, and danceability helped distinguish AI and non-AI tracks. My AI track appeared in clusters with other AI-generated songs, which probably reflects how many of us used similar tools and prompts—so the output ends up sounding similar, even unintentionally. 

Overall, I really enjoyed the process. Even though sometimes it waas really tough without musical understanding.
